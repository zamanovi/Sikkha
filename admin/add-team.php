 ...
 needLoogged();
    ...
    if(!empty($_POST)){
      ...
      $image=$_FILES['pic'];     $imageName='user_'.time().'_'.rand(100000,1000000000).'.'.pathinfo($image['name'],PATHINFO_EXTENSION);
            ...
            $insert="INSERT INTO cs_team(team_name,team_des,team_cont,team_pic)
            VALUES('$name','$des','$cont','$imageName')";
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<div class="col-md-3 text-right">
					<a href="all-team.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i> All Team</a>
				</div>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" name="cont" placeholder="">
					</div>
				</div>
